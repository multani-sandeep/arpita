To build credibility in delivering AI projects from scratch, you have a massive advantage: you already have the foundational enterprise delivery skills that most "AI enthusiasts" lack.

Reading your CV and the EU AI Act Risk Tiers document, it is clear that successfully delivering an AI project isn't about knowing how to code neural networks; it's about governance, risk management, data security, and cross-functional orchestration—areas where you already excel as a Senior Project Manager.
...
Change from: "...concurrently managing Copilot rollout, ServiceNow setup..."
...
By combining your proven track record in complex, large-scale delivery with a newly published, articulate perspective on AI project governance, you immediately position yourself in the top percentile of Project Managers currently navigating the AI transformation space.